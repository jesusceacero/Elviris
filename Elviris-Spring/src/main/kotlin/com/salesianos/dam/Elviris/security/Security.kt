...
class WebSecurityConfiguration(
    ...
    override fun configure(http: HttpSecurity) {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET, "/eventos/**","/user/me").hasRole("USER")
                .antMatchers(HttpMethod.POST, "/eventos/**","/eventos/add/**","/user/me").hasRole("USER")
                .antMatchers(HttpMethod.DELETE, "/eventos/**").hasRole("USER")
                .antMatchers(HttpMethod.PUT, "/eventos/**").hasRole("USER")
